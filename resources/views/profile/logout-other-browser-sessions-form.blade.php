<x-jet-action-section class="px-4">
    <x-slot name="title">
        {{ __('Sesiones activas') }}
    </x-slot>
    ...
    <x-slot name="content">
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        {{ __('Ultima actividad hace') }} {{ str_replace(' ago', '', $session->last_active) }}
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesion en los otros navegadores') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                {{ __('Cerrar sesion en otros otros navegadores') }}
            </x-slot>
            ...
            <x-slot name="content">
                ...
                <input type="password"
                            ...
                            class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 ring-offset-current ring-gray-500">
